...
```bash
bash ~/.openclaw/skills/bilibili-video-fix/scripts/fix.sh <input.mp4> [output_name]
```

示例：
```bash
bash ~/.openclaw/skills/bilibili-video-fix/scripts/fix.sh video.mp4 my_video
